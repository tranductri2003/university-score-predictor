...
destination_folder = r'DATA\CLEAN DATA\Điểm thi THPTQG [2018-2023]\Clean_CSV_Files'
# Tạo file csv mới để thống kê TBC cho từng tỉnh, từng năm
destination_csv = r'DATA\CLEAN DATA\Điểm thi THPTQG [2018-2023]\university_scores_clean.csv'
