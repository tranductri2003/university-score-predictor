...
with open('DATA\RAW DATA\Chỉ số sức khỏe [2018-2020]\Thống kê chỉ số giai đoạn 2018 - 2020 - 6. Chỉ số sức khỏe của cả nước và các địa phương giai đoạn 2018 - 2020.csv', 'r', encoding='utf-8') as csvfile:
...
with open('DATA\CLEAN DATA\Chỉ số sức khỏe [2018-2020]\Chỉ số sức khỏe [2018-2020].csv', 'w', newline='', encoding='utf-8') as csvfile:
